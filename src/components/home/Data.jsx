...
const Data = () => {
  return (
    <div className="home__data">
        ...
        Senior Software Engineer Results-driven
        Full Stack Developer with a proven track
        record of success in the <b>MERN</b> stack and a
        unique proficiency in integrating machine
        learning solutions. With over <b>6.6 years</b> of
        hands-on experience, I have consistently
        delivered innovative and high-performance
        web applications. Expertise spans both
        front-end and back-end development, with
        a focus on seamless integration of machine
        learning models to enhance functionality
        and user experiences. Adept at leading
        development teams, implementing scalable
        architectures, and staying abreast of the
